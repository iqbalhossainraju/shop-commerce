            ...
            <div className="grid grid-cols-2 lg:grid-cols-7 gap-5">
                <div >
                    <Link to="/" className="text-center inline-block hover:underline">
                        <img class="expImg" src={exBrands} alt="" />
                        <p className="mt-5">Apple</p>
                    </Link>
                </div>
                <div>
                    <Link to="/" className="text-center inline-block hover:underline">
                        <img class="expImg" src={exBrands2} alt="" />
                        <p className="mt-5">Samsung</p>
                    </Link>
                </div>
                <div>
                    <Link to="/" className="text-center inline-block hover:underline">
                        <img class="expImg" src={exBrands3} alt="" />
                        <p className="mt-5">Sony</p>
                    </Link>
                </div>
                <div>
                    <Link to="/" className="text-center inline-block hover:underline">
                        <img class="expImg" src={exBrands4} alt="" />
                        <p className="mt-5">Ugreen</p>
                    </Link>
                </div>
                <div>
                    <Link to="/" className="text-center inline-block hover:underline">
                        <img class="expImg" src={exBrands5} alt="" />
                        <p className="mt-5">Xiaomi</p>
                    </Link>
                </div>
                <div>
                    <Link to="/" className="text-center inline-block hover:underline">
                        <img class="expImg" src={exBrands6} alt="" />
                        <p className="mt-5">Nike</p>
                    </Link>
                </div>
                <div>
                    <Link to="/" className="text-center inline-block hover:underline">
                        <img class="expImg" src={exBrands7} alt="" />
